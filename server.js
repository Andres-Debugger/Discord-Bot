...
client.on("message", message =>{
    if (message.content.startsWith("!presupuesto") && message.content.length > 30){
        message.channel.send("Hola, ya estamos trabajando para recomendarte los mejores componentes y ayudarte en lo que nesecites, te estaremos enviando el resultado final lo antes posible, mucha suerte!! :revolving_hearts: ");
      }
